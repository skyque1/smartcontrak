...
const Input =({placeholder,name,type,value,handleChange,step,onChange}) => (
  <input
...
return (
    <div className="flex w-full justify-center items-center">
        <div
            className="flex md:flex-row flex-col items-start justify-between mf:p-20 py-12 px-4">
            <div className="flex flex-1 justify-start flex-col md:mr-10">
                ...
                <p className="text-left mt-5 text-purple-400 font-light md:w-9/12 w-11/12 text-base">
                  ...
                  <br/>
                  <div className="typewriter"><h1>Buy and sell cryptocurency easily on Skyque.</h1></div>
                </p>
                <button
                    type="button"
            ...
            <div className="flex flex-col flex-1 items-center justify-start w-full mf:mt-0 mt-10">
              ...
              Ethereum
               ...
               <div className="p-5 sm:w-96 w-full flex flex-col justify-start items-center blue-glassmorphism">
                ...
                <Input placeholder="Amount (MONERO)" Name="amount" type="number" handleChange={()=>{}} />
